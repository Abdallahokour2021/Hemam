...
class FormSugg extends GetWidget {
  String postId;
  String eventName;
  String n;
                        ...
                        onPressed: () {
                          if (isValide2().contains(0)) {
                            ...
                            isConnected().then((state) {
                              if (state) {
                                sendSugg(
                                        "${_.firstName} ${_.parentName} ${_.lastName}",
                                        _.info,
                                        _.email,
                                        _.numberPhone)
                                    .then((value) {
